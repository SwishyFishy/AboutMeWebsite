    ...
    return(
        <div id="about_me">
            ...
            <div>
                ...
                <p>
                    Perhaps unsurprisingly, I enjoy programming. I'm especially fond of data management and algorithm design, but I'm also quite fond of front and backend web development. I've also dabbled in machine learning before, and would like to do more of it. In my free time, I like to play video games (mainly roguelikes and story-driven action/FPS games) and the Magic: the Gathering trading card game.
                </p>
                <p>
